...
IN.propulsion.oxidizer_mass = 12; % kg -> internal
IN.propulsion.fuel_mass = 12; % kg -> internal
...
IN.propulsion.throttle_range = [0.46 1.1];
...
IN.tvc.max_gimbal_rate = deg2rad(15); % rad/s ?
IN.tvc.voltage = 24; % V
IN.tvc.current = 3; % A
