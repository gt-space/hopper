function [Trajectory,unom,tgrid] = Trajectory3()

clearvars -except Trajectory unom tgrid
clc
...
%% ================= RCS EXCITATION =================
% small sinusoidal force to excite roll dynamics

F_rcs = 20*sin(0.35*tgrid);   % Newtons
